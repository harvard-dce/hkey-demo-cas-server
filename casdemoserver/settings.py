"""
Django settings for casdemoserver project.
...
SECRET_KEY = "#+4_za=by%$u56s*_7kb(5#qwf%c9gld7&!)+3a!n$ac6=@ho8!dce!"
...
ROOT_URLCONF = "casdemoserver.urls"
...
WSGI_APPLICATION = "casdemoserver.wsgi.application"
